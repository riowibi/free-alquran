/**
 * Script untuk scrape data Quran Juz 20-29 dari equran.id API
 * Fetch semua surah untuk masing-masing Juz dan simpan ke file terpisah
 * 
 * API: https://equran.id/api/v2/surat/${number}
 * 
 * Penggunaan: node scripts/scrape-equran-juz20-29.js
 */
...
// Juz 20-29 dengan range surah untuk masing-masing juz
const JUZ_SURAHS = {
  20: [37, 38, 39, 40, 41],
  21: [42, 43, 44, 45, 46, 47],
  22: [48, 49, 50, 51, 52, 53],
  23: [54, 55, 56, 57, 58, 59],
  24: [60, 61, 62, 63, 64, 65, 66],
  25: [67, 68, 69, 70, 71],
  26: [72, 73, 74, 75, 76, 77],
  27: [78, 79],
  28: [80, 81, 82],
  29: [83, 84, 85, 86, 87, 88],
};
...
/**
 * Main scraper untuk Juz 20-29
 */
async function scrapeAllJuz() {
  console.log(`\n🚀 Scraping Quran Juz 20-29 dari equran.id\n`);
  ...
  // Summary keseluruhan
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📊 SUMMARY - Semua Juz 20-29:`);
